...
Confirmed at the second rebase: #66's D-101 and #68's D-099 are both on
main now, so the block is real and being spent. This may still need
reconciling if #72 is assigned a number of its own.
