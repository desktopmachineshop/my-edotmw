...
w('**#324 owns the set.** A make-main-green PR should not carry design; the\n')
w('dedicated PR with the decision entry and the art-tied per-unit reasoning\n')
w('does. Agreed by both authors 2026-08-28.\n\n')
...
w('#243 drops **only** the last two, so it keeps two `shield_wall` grantees\n')
w('and stays green at its own merge point — no red window, and #324 need not\n')
w('move wave. Verified end to end: #243 with the two dropped is 5/5 on\n')
w('`test_fighting_styles`; merging #324 after conflicts on `emberdeep_heavy`\n')
w("alone; the final set is exactly #324's three.\n\n")
