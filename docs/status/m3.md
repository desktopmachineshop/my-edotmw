...
**The opening changed in M3, and changed again on 2026-08-23 — read
`docs/status/the-opening.md` for what ships now
(D-20260823-the-opening-is-a-crew-and-a-general). As M3's history:**
a player started with ONE founding party and no base. Founders
